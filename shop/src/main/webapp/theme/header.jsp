...
<head>
    ...
    <!-- Favicon -->
    <link href="<%=request.getContextPath() %>/theme/img/favicon.ico" rel="icon">
    ...
    <link href="<%=request.getContextPath() %>/theme/lib/animate/animate.min.css" rel="stylesheet">
    <link href="<%=request.getContextPath() %>/theme/lib/owlcarousel/assets/owl.carousel.min.css" rel="stylesheet">
                ...
                <div class="d-inline-flex align-items-center">
                    <div class="btn-group">
                        ...
                        <div class="dropdown-menu dropdown-menu-right">
                       		<a href="<%=request.getContextPath() %>/login/loginForm.jsp" class="dropdown-item">Sign in</a>
                       		<a href="<%=request.getContextPath() %>/login/addCustomer.jsp" class="dropdown-item">고객회원가입</a>
                       		<a href="<%=request.getContextPath() %>/login/addEmployee.jsp" class="dropdown-item">직원회원가입</a>
                        </div>
                    </div>
